...
// See https://github.com/bbirec/goauth2/issues/detail?id=31 for background.
// In summary:
...
func providerAuthHeaderWorks(tokenURL string) bool {
	if strings.HasPrefix(tokenURL, "https://accounts.google.com/") ||
		...
		strings.HasPrefix(tokenURL, "https://api.box.com/") {
...
func providerRemoveScope(tokenURL string) bool {
	if strings.HasPrefix(tokenURL, "https://api.dropbox.com/") {
		return true
	}
...
func (t *Transport) updateToken(tok *Token, v url.Values) error {
	...
	if providerRemoveScope(t.TokenURL) {
		v.Del("scope")
		v.Del("client_id")
	}
